...
/***/ function(module, exports, __webpack_require__) {
	...
	var _projectStore = __webpack_require__(165);
	...
	dataItems.forEach(function (item) {
	  return projectStore.addProject(item);
	});
	
	_reactDom2.default.render(_react2.default.createElement(_home2.default, { mainData: mainData, store: projectStore }), document.getElementById('main-app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _highlight = __webpack_require__(164);
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'div',
	        { className: 'col-xs-12' },
	        _react2.default.createElement(_highlight2.default, { type: 'primary', title: props.mainData.title, subtitle: props.mainData.subtitle, category: props.mainData.category, imageUrl: props.mainData.imageUrl })
	      )
	    ),
	    _react2.default.createElement(
	      'div',
	      { className: 'row' },
	      props.store.projects.map(function (item) {
	        return _react2.default.createElement(
	          'div',
	          { className: 'col-xs-12 col-sm-6' },
	          _react2.default.createElement(_highlight2.default, { type: item.type, imageUrl: item.imageUrl, subtitle: item.subtitle, alt: item.alt, title: item.title, category: item.category })
	        );
	      })
	    ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Footer = function Footer() {
	  return _react2.default.createElement(
	    "footer",
	    { className: "c-footer l-footer l-main-footer" },
	    _react2.default.createElement(
	      "div",
	      { className: "row l-footer__row" },
	      _react2.default.createElement(
	        "div",
	        { className: "col-sm-6 l-footer__col" },
	        _react2.default.createElement(
	          "div",
	          { className: "footer__credits" },
	          _react2.default.createElement(
	            "div",
	            { className: "col-xs-4 l-footer__col footer__credit" },
	            _react2.default.createElement(
	              "spam",
	              { className: "footer__credit-title" },
	              "Design"
	            ),
	            ": Daniel Caldeira"
	          ),
	          _react2.default.createElement(
	            "div",
	            { className: "col-xs-6 l-footer__col footer__credit" },
	            _react2.default.createElement(
	              "spam",
	              { className: "footer__credit-title" },
	              "Desenvolvimento"
	  ...
	  _createClass(ProjectStore, [{
	    ...
	    value: function fetchProjects() {
	      ...
	      (0, _axios2.default)({
	        ...
	        response.data.forEach(function (newProjectData) {
	          return _this.projects.push(newProjectData);
	        });
	    ...
	    value: function addProject(projectData) {
	      this.projects.push(new _Project2.default(projectData));
	    }
	  }]);
...
/***/ function(module, exports) {
	...
	var Project = function Project() {
	  var item = arguments.length <= 0 || arguments[0] === undefined ? { title: 'Title', subtitle: 'Subtitle', category: null, imageUrl: '', featured: false } : arguments[0];
